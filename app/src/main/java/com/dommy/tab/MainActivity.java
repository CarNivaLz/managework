...
public class MainActivity extends BaseActivity {
     ...
     * 菜单标题
     */
    private final int[] TAB_TITLES = new int[]{R.string.menu_project, R.string.menu_achievement, R.string.menu_search, R.string.menu_me};
    /**
     * 菜单图标
     */
    private final int[] TAB_IMGS = new int[]{R.drawable.tab_main_project_selector, R.drawable.tab_main_achievement_selector, R.drawable.tab_main_search_selector
