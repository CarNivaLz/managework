...
import com.dommy.tab.fragment.AchievementsContentFragment;
...
public class AchievementsFragmentAdapter extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        AchievementsContentFragment fragment = new AchievementsContentFragment();
